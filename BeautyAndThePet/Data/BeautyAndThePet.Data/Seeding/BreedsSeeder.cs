namespace BeautyAndThePet.Data.Seeding
{
    ...
    public class BreedsSeeder : ISeeder
    {
        public async Task SeedAsync(ApplicationDbContext dbContext, IServiceProvider serviceProvider)
        {
            ...
            await dbContext.Breeds.AddAsync(new Breed { Name = "---Dog Breeds---", Characteristics = null, TypeOfPet = TypeOfPet.Dog });
            ...
            await dbContext.Breeds.AddAsync(new Breed { Name = "---Cat Breeds---", Characteristics = null, TypeOfPet = TypeOfPet.Dog });
